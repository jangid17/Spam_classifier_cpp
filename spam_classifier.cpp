...
void updateFrequencies(AppData* app, bool isSpam) {
    ...
    saveWordFrequenciesToTransposedCSV("/Dsa_project/final.csv", app->wordsOrder, &app->chainMap);   //slvnw[doin'alskj[bvaknsw'kbna'sknb']]
}
...
int main(int argc, char* argv[]) {
    ...
    loadWordFrequenciesFromTransposedCSV("/Dsa_project/final.csv", &app.chainMap, &app.openMap, app.wordsOrder); //lvnq[awinbv'lkasdjffwjegkn'sdg]
